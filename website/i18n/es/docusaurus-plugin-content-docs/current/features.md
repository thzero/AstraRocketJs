...
- **Adaptable** — un banco de trabajo de tres paneles en escritorio que en el teléfono pasa a pestañas (Cohete · Croquis · Simular, más **Resultados** en cuanto una ejecución produce alguno), donde las vistas del cohete giran un cuarto de vuelta para que el fuselaje recorra el lado largo de la pantalla y los diálogos la ocupan entera.
