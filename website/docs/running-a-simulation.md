...
If the design can't fly — **no motor mount** or **no motor loaded** — the Run button is disabled and shows why, so add a motor mount (see [Designing a Rocket](./designing-a-rocket.md)) or pick a motor first.
