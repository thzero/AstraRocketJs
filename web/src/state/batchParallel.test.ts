...
import { simStatus, type SimPrefs } from '../services/simulations';
...
import { SimCanceledError } from '../engine/simClient';
import type { SimCallOptions } from '../engine/simClient';
import type { SimPayload } from '../engine/simProtocol';
