...
export function DragAnalysis() {
  ...
  if (!sweep)
    return <div className="grid h-full place-items-center text-sm text-slate-500">{t('drag.unavailable')}</div>;
    ...
    <div className="flex h-full flex-col rounded-xl bg-slate-900 ring-1 ring-white/10">
      ...
      <div className="min-h-0 flex-1 space-y-2 overflow-y-auto px-3 pb-3">
        ...
        <ChartCard
          ...
          right={
            <Seg
              options={['type', 'component'] as const}
              value={mode}
              onChange={setMode}
