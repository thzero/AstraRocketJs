...
public class BarrowmanStabilityCalculator implements StabilityCalculator {
	...
	// PATCH(astrarrocketjs): reflection-free calc construction. Upstream calls
	// Reflection.construct(BARROWMAN_PACKAGE, comp, BARROWMAN_SUFFIX, comp), which
	// walks the component class hierarchy invoking Class.forName(<SimpleName> +
