...
//			final double yCentroid = segmentCrossSection.y; ///< heuristic, not exact
			final double segmentLength = Geo2D.distance(prev.x, prev.y, cur.x, cur.y);
